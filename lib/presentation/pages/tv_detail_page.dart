    ...
    return Scaffold(
      body: BlocBuilder<TvDetailBloc, TvDetailState>(
        builder: (context, state) {
          ...
          } else if (state is TvDetailAddRemoveSuccess) {
            final tv = state.tv;
            return SafeArea(
              child: DetailContent(
                tv,
...
class DetailContent extends StatelessWidget {
                            ...
                            FilledButton(
                              onPressed: () async {
                                ...
                                final state = await context
                                    ...
                                    .firstWhere(
                                      (state) =>
                                          state is TvDetailAddRemoveSuccess ||
                                          state is TvDetailError,
                                    );

                                if (state is TvDetailAddRemoveSuccess) {
  ...
  String _showDuration(int numberOfSeasons, int numberOfEpisodes) {
    return '${numberOfSeasons} Season(s) / ${numberOfEpisodes} Episode(s)';
  }
}
